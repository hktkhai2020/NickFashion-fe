...
const Header = () => {
  ...
  return (
    <>
      <div className="header-main w-full flex flex-col relative">
        {/*banner promotion */}
        <div className="header-promotion w-full bg-[#519656]">
        ...
        {/* menu*/}
        <div className="header-menu w-full bg-[#333f48] flex items-center shadow-sm lg:px-[5rem]! px-[0.5rem]! relative z-40 text-nowrap overflow-x-auto overflow-y-hidden lg:overflow-visible">
          <ul className="flex items-center font-semibold text-white text-[13px] h-[45px]">
            ...
            <li className="group h-full flex items-center cursor-pointer" onClick={() => toggleMenu('NU')}>
              <span className="hover:text-[#333f48] hover:bg-white transition-colors uppercase h-full flex items-center px-[20px]!">
                NỮ
              </span>
              {/* Mega Menu Dropdown */}
              <div className={`fixed inset-0 lg:absolute lg:inset-auto lg:left-0 lg:top-[45px] w-full h-[100dvh] lg:h-auto overflow-y-auto lg:overflow-visible bg-white shadow-xl transition-all duration-300 z-[100] lg:z-50 text-black border-t border-gray-100 lg:border-t-0 ${activeMenu === 'NU' ? 'opacity-100 visible' : 'opacity-0 invisible lg:group-hover:opacity-100 lg:group-hover:visible'}`}>
                ...
                <div className="flex lg:hidden items-center justify-between px-[1.5rem] py-4 border-b border-gray-200 sticky top-0 bg-white z-10">
                  ...
                  <button onClick={(e) => { e.stopPropagation(); toggleMenu('NU'); }} className="text-gray-500 hover:text-red-500">
                ...
                <div className="w-full flex flex-col lg:flex-row px-[1.5rem]! lg:px-[5rem]! py-6! lg:py-8! gap-[20px] lg:gap-[80px]">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    <ul className="flex flex-col gap-3 font-normal text-[#4d575f] text-[14px]">
                      <li className="hover:text-red-500 hover:translate-x-1 transition-transform">
                        Áo phông / Áo thun
                      </li>
                      <li className="hover:text-red-500 hover:translate-x-1 transition-transform">
                        Áo polo
            ...
            <li className="group h-full flex items-center cursor-pointer" onClick={() => toggleMenu('NAM')}>
              <span className="hover:text-[#333f48] hover:bg-white transition-colors uppercase h-full flex items-center px-[20px]!">
                Nam
              </span>
              <div className={`fixed inset-0 lg:absolute lg:inset-auto lg:left-0 lg:top-[45px] w-full h-[100dvh] lg:h-auto overflow-y-auto lg:overflow-visible bg-white shadow-xl transition-all duration-300 z-[100] lg:z-50 text-black border-t border-gray-100 lg:border-t-0 ${activeMenu === 'NAM' ? 'opacity-100 visible' : 'opacity-0 invisible lg:group-hover:opacity-100 lg:group-hover:visible'}`}>
                ...
                <div className="flex lg:hidden items-center justify-between px-[1.5rem] py-4 border-b border-gray-200 sticky top-0 bg-white z-10">
                  ...
                  <button onClick={(e) => { e.stopPropagation(); toggleMenu('NAM'); }} className="text-gray-500 hover:text-red-500">
                    <CloseOutlined className="text-[20px]" />
                  </button>
                </div>
                <div className="w-full flex flex-col lg:flex-row px-[1.5rem]! lg:px-[5rem]! py-6! lg:py-8! gap-[20px] lg:gap-[80px]">
            ...
            <li className="group h-full flex items-center cursor-pointer" onClick={() => toggleMenu('BEGAI')}>
              <span className="hover:text-[#333f48] hover:bg-white transition-colors uppercase h-full flex items-center px-[20px]!">
                Bé gái
              </span>
              <div className={`fixed inset-0 lg:absolute lg:inset-auto lg:left-0 lg:top-[45px] w-full h-[100dvh] lg:h-auto overflow-y-auto lg:overflow-visible bg-white shadow-xl transition-all duration-300 z-[100] lg:z-50 text-black border-t border-gray-100 lg:border-t-0 ${activeMenu === 'BEGAI' ? 'opacity-100 visible' : 'opacity-0 invisible lg:group-hover:opacity-100 lg:group-hover:visible'}`}>
                ...
                <div className="flex lg:hidden items-center justify-between px-[1.5rem] py-4 border-b border-gray-200 sticky top-0 bg-white z-10">
                  ...
                  <button onClick={(e) => { e.stopPropagation(); toggleMenu('BEGAI'); }} className="text-gray-500 hover:text-red-500">
                    <CloseOutlined className="text-[20px]" />
                  </button>
                </div>
                <div className="w-full flex flex-col lg:flex-row px-[1.5rem]! lg:px-[5rem]! py-6! lg:py-8! gap-[20px] lg:gap-[80px]">
            ...
            <li className="group h-full flex items-center cursor-pointer" onClick={() => toggleMenu('BETRAI')}>
              <span className="hover:text-[#333f48] hover:bg-white transition-colors uppercase h-full flex items-center px-[20px]!">
                BÉ TRAI
              </span>
              <div className={`fixed inset-0 lg:absolute lg:inset-auto lg:left-0 lg:top-[45px] w-full h-[100dvh] lg:h-auto overflow-y-auto lg:overflow-visible bg-white shadow-xl transition-all duration-300 z-[100] lg:z-50 text-black border-t border-gray-100 lg:border-t-0 ${activeMenu === 'BETRAI' ? 'opacity-100 visible' : 'opacity-0 invisible lg:group-hover:opacity-100 lg:group-hover:visible'}`}>
                ...
                <div className="flex lg:hidden items-center justify-between px-[1.5rem] py-4 border-b border-gray-200 sticky top-0 bg-white z-10">
                  ...
                  <button onClick={(e) => { e.stopPropagation(); toggleMenu('BETRAI'); }} className="text-gray-500 hover:text-red-500">
                    <CloseOutlined className="text-[20px]" />
                  </button>
                </div>
                <div className="w-full flex flex-col lg:flex-row px-[1.5rem]! lg:px-[5rem]! py-6! lg:py-8! gap-[20px] lg:gap-[80px]">
            ...
            <li className="group h-full flex items-center cursor-pointer" tabIndex={0}>
              <span className="hover:text-[#333f48] hover:bg-white transition-colors uppercase h-full flex items-center px-[20px]!">
                SẢN PHẨM MỚI
              </span>
            </li>

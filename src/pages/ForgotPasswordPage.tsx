...
import { Form, Input, Button, Divider, notification, Steps } from "antd";
    ...
    <div className="auth-login">
      <div className="auth-background">
        ...
        <div className="form-container">
          <div className="cursor-pointer bg-[#4780d6] text-white  w-[5rem]  rounded-md text-center !p-1 !mb-[1.5rem]">
            Quay Lại
          </div>
